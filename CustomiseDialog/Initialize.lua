...
function addonTable.CustomiseDialog.Initialize()
  -- Create shortcut to open Coolinator options from the Bliizzard addon options
  -- panel
  ...
  local version = C_AddOns.GetAddOnMetadata("Coolinator", "Version")
  ...
  header:SetText(LINK_FONT_COLOR:WrapTextInColorCode(addonTable.Locales.COOLINATOR))
